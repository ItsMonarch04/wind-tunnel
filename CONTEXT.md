...
**Last committed version:** v0.8.3 · **Current status:** P7a is locally complete and committed; P0 remote CI/deployed-shell gates remain · **Last verified:** 2026-07-24 (S21)
...
| Fact | Verified state |
|---|---|
| Version | The local P0 series is **v0.1.0…v0.1.7**, P1 is **v0.2.0…v0.2.4**, P2 is **v0.3.0…v0.3.2**, P3 is **v0.4.0…v0.4.5**, P4 is **v0.5.0…v0.5.3**, P5 is **v0.6.0…v0.6.4**, P6a is **v0.7.0…v0.7.3**, and P7a is **v0.8.0…v0.8.3**. The latest commit is `Commit v0.8.3: Uncertainty Acceptance + P7a Handoff /4-F5-T6`, post-dated 2026-07-24 12:45 +05:30. `package.json`, both lockfile root versions, the footer, and README's Version Control block agree at v0.8.3. P0 remains open despite its versioned local history. |
| Git | Branch `main` tracks `origin/main` and is **thirty-nine local commits ahead** after S21. `origin/main` remains at `da5ba98` (v0.0.4); no push was attempted. There are no tags, other local branches, or submodules. |
| Working tree | P5’s committed design editor, pure linter, scenario-to-engine adapter, test coverage, browser flow, and status updates remain intact. P6a’s live Simulate surface, sweep adapter, acceptance tests, and v0.7.3 metadata are committed. P7a’s pure uncertainty engine, state adapter, Analyze view, acceptance coverage, and v0.8.3 metadata are committed; generated build/test output remains ignored. |
| Product | P1–P2's tested economics core and P3 scenario foundation remain intact. P4 adds a first-run template picker, model segment cards, P50-centred size/WTP bands, explicit within-segment spread, provenance selectors, a keyboard-navigable allocation/direct-value matrix, glossary popovers, and engine-backed preview KPIs. P5 adds editable tiers, free tier, feature fences, add-ons, design alternatives, and a deterministic, cited linter with engine-backed counterfactuals. P6a reveals live KPIs, buyer sorting, a reconciled value waterfall, and deferred 400-point per-tier price sweeps with equivalent data tables and a polite live announcement. P7a adds deterministic P10/P50/P90 MRR bands, common-random-number design comparisons, one-at-a-time tornado drivers, and provenance-led validation to-dos. Exact own/competitor identity ties remain competitor-first. |
...
3. **Next implementation phase:** begin **P7b — Van Westendorp** (§6), retaining its survey-first input validation and explicit undefined-crossing states.
4. **Future pushes:** the local P0/P1/P2/P3/P4/P5/P6a/P7a series is committed but unpushed. Push only when separately asked.
