...
|---|---|---|
| B-001 | **Open; owner decision required before P1** | Equivalent own/competitor offers are geometrically identical but feed different revenue and loss terms. §4.2 needs an ownership tie policy and a regression test. |
