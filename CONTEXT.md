...
**Version:** v0.0.3 · **Status:** review-hardened per owner S2/S2b — oracle reconciliation, corrected economic/positioning/Conjoint contracts, bounded sharing, and an unambiguous v1.0/v1.1 release contract; **renamed Product Studio → Wind Tunnel (v0.0.3, S3, ledger D-29)** · **Last updated:** 2026-07-13
