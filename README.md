...
> **Status: P5 locally complete (latest committed version v0.6.4).** The static shell and local checks are ready; remote CI and deployment remain pending. Buyer-distribution math and economics have a tested pure-engine contract, scenarios persist locally and share safely, and the Model and Design workbenches now edit buyer assumptions and packaging menus with immediate deterministic feedback.
...
- **Base Format Version:** 0.6.4
- **Portfolio Version:** v0.6.4_2026-07-23_19:00:00 (IST)
