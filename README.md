...
> **Status: P0 shell locally verified (v0.1.7).** The build plan is complete and owner-approved ([CONTEXT.md](CONTEXT.md)). The static shell, local checks, and CI workflow are ready; remote CI and deployment remain pending, and the pricing engine has not started. One recorded owner policy choice (offer-tie attribution) gates P1.
...
- **Base Format Version:** 0.1.7
- **Portfolio Version:** v0.1.7_2026-07-19_04:30:00 (IST)
