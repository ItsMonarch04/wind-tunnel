...
> **Status: P5 linter core in progress (v0.6.1).** The static shell and local checks are ready; remote CI and deployment remain pending. Buyer-distribution math and economics have a tested pure-engine contract, scenarios persist locally and share safely, and Design menus can now be evaluated by the deterministic economics path.
...
- **Design** — in progress: editable tiers, feature fences, free tier, add-ons, flat or per-seat pricing, and multiple design alternatives. Its deterministic linter core evaluates menu counterfactuals; findings and workbench presentation follow in the next P5 commits.
...
| P5      | Design surface + design linter                                           | Linter core         |
...
- **Portfolio Version:** v0.6.1_2026-07-23_18:15:00 (IST)
