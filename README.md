...
> **Status: P7d-1 Conjoint engine locally committed (latest committed version v0.13.0). The static shell and local checks are ready; remote CI and deployment remain pending. Buyer-distribution math, economics, Van Westendorp PSM, bundling regimes, Conjoint MNL estimation, and the Pricing Decision Record have tested pure-engine contracts; scenarios persist locally and share safely, and the Model, Design, Simulate, Uncertainty, Research (PSM + Bundling), and Share workbenches make assumptions, evidence, decisions, mechanism envelopes, design comparisons, bundling verdicts, and pricing-page previews inspectable.**
...
- **Base Format Version:** 0.13.0
- **Portfolio Version:** v0.13.0_2026-07-25_03:30:00 (IST)
