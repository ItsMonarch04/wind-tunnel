...
> **Status: P3 scenario-aware shell in progress (v0.4.4).** The static shell and local checks are ready; remote CI and deployment remain pending. Buyer-distribution math and economics now have a tested pure-engine contract; scenarios now restore and autosave in the shell, and theme/seed settings live in scenario state, while the user-facing sharing controls and product surfaces remain ahead.
...
| P3      | Scenarios: persistence, import/export, share-by-URL, templates           | P3 shell integration |
...
- **Base Format Version:** 0.4.4
- **Portfolio Version:** v0.4.4_2026-07-21_02:30:00 (IST)
