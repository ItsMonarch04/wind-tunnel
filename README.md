...
> **Status: plan finalized, pre-build (v0.0.4).** The build plan is complete, audited, and owner-approved ([CONTEXT.md](CONTEXT.md)); implementation starts at the P0 scaffold, and one recorded owner policy choice (offer-tie attribution) gates the P1 engine phase. Application code lands phase by phase. This README stays honest about what runs today: nothing yet.
