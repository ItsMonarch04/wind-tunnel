...
> **Status: P2 economics test suite (v0.3.1).** The static shell and local checks are ready; remote CI and deployment remain pending. Buyer-distribution math, joint offer expansion, deterministic self-selection, economics readouts, and their named formula/oracle tests are now in place; product surfaces remain ahead.
...
| P1–P2   | Economics engine (selection, KPIs, surplus, sweeps) + math spec          | P2 verification     |
...
- **Portfolio Version:** v0.3.1_2026-07-20_10:15:00 (IST)
